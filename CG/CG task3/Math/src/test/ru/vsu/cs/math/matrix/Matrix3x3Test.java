...
public class Matrix3x3Test {
    @Test
    void zeroMatrix() {
        Matrix3x3 matrix1 = new Matrix3x3(0, 0, 0, 0, 0, 0, 0, 0, 0);
    ...
    @Test
    void identityMatrix() {
        Matrix3x3 matrix1 = new Matrix3x3(1, 0, 0, 0, 1, 0, 0, 0, 1);
    ...
    @Test
    void add() {
        Matrix3x3 matrix1 = new Matrix3x3(1, 2, 3, 4, 5, 6, 7, 8, 9);
        Matrix3x3 matrix2 = new Matrix3x3(4, 5, 3, 1, 4, 5, 6, 9, 0);
        Matrix3x3 matrixResult = matrix1.add(matrix2);
        Matrix3x3 matrix = new Matrix3x3(5, 7, 6, 5, 9, 11, 13, 17, 9);
    ...
    void sub() {
        ...
        Matrix3x3 matrix = new Matrix3x3(-3, -3, 0, 3, 1, 1, 1, -1, 9);
        Assertions.assertTrue(matrix.equals(matrixResult));
    }

    @Test
    void mul() {
        Matrix3x3 matrix1 = new Matrix3x3(1, 4, 3, 2, 1, 5, 3, 2, 1);
        Matrix3x3 matrix2 = new Matrix3x3(5, 2, 1, 4, 3, 2, 2, 1, 5);
        Matrix3x3 matrixResult = matrix2.mulMatrix(matrix1);
        Matrix3x3 matrix = new Matrix3x3(12, 24, 26, 16, 23, 29, 19, 19, 16);
        Assertions.assertTrue(matrix.equals(matrixResult));
    }

    @Test
    void mulVector() {
        Matrix3x3 matrix1 = new Matrix3x3(2, 4, 0, -2, 1, 3, -1, 0, 1);
    ...
    void transposition() {
        Matrix3x3 matrix1 = new Matrix3x3(1, 4, 3, 2, 1, 5, 3, 2, 1);
        Matrix3x3 matrixTr = new Matrix3x3(1, 2, 3, 4, 1, 2, 3, 5, 1);
        Assertions.assertTrue(matrixTr.equals(matrix1.transposition()));
    }

    @Test
    void inverseMatrix() {
        Matrix3x3 matrix1 = new Matrix3x3(2, 5, 7, 6, 3, 4, 5, -2, -3);
        Matrix3x3 matrixIn = new Matrix3x3(1, -1, 1, -38, 41, -34, 27, -29, 24);
